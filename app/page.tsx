  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section id="inicio" className="mx-auto grid max-w-7xl items-center gap-14 px-6 py-16 lg:grid-cols-2 lg:py-28">
        <div>
          <p className="mb-6 inline-flex items-center gap-2 rounded-full border border-border bg-muted px-3 py-1.5 text-xs font-medium text-muted-foreground">
            <span className="h-2 w-2 rounded-full bg-accent-cyan" /> Seu dinheiro, no controle</p>
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row"><Link href="/auth/signup" className="rounded-full bg-primary px-6 py-3 text-center text-sm font-semibold text-primary-foreground shadow-glow-primary">Criar minha conta grátis →</Link>
      ...
      <section id="comecar" className="px-6 py-20 text-center">
        ...
        <Link href="/auth/signup" className="mt-7 inline-block rounded-full bg-primary px-7 py-3 text-sm font-semibold text-primary-foreground shadow-glow-primary">
