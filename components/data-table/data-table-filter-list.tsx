  ...
  return (
    ...
    >
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger render={<Button variant="outline" className="font-normal" onKeyDown={onTriggerKeyDown} disabled={disabled} />}><ListFilter className="text-muted-foreground" />Filtrar
                          {filters.length > 0 && (
                            <Badge
                              variant="secondary"
        ...
        >
          <div className="flex flex-col gap-1">
            ...
            >
              {filters.length > 0
                ? "Ajuste os filtros para refinar suas transações."
                : "Adicione filtros para encontrar transações específicas."}
            </p>
          </div>
          {filters.length > 0 ? (
            <SortableContent>
    ...
    <SortableItem value={filter.filterId} asChild><div role="listitem" id={filterItemId} tabIndex={-1} className="flex items-center gap-2" onKeyDown={onItemKeyDown}><div className="min-w-18 text-center">
                {index === 0 ? (
                  ...
                  >
                    ...
                    >
                      <SelectValue placeholder={joinOperator === "and" ? "e" : "ou"} />
                    </SelectTrigger>
                    <SelectContent
